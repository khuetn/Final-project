...
function Search(props) {
  ...
  const [filter, setFilter] = React.useState(query.toLowerCase());
  ...
  if (products) {
    const contentSearch = filter.toLowerCase();
    console.log("ok", contentSearch);
    const matchedProducts = products.filter((product) => {
      return (
        // product.description.toLowerCase().includes(contentSearch) ||
        product.name.toLowerCase().includes(contentSearch)
        // product.NSX.toLowerCase().includes(contentSearch)
      );
    });
