          ...
          <form className="checkout__form">
            <div className="checkout__form-info">
              <div className="form__group">
                ...
                <input type="text" name="address" id="checkoutName" />
              </div>
              <div className="form__group">
                <label for="checkoutAddress">Địa chỉ nhận hàng</label>
                <input type="text" name="address" id="checkoutAddress" />
              </div>
              <div className="form__group">
                <label for="checkoutPhone">Số điện thoại</label>
                <input type="number" name="address" id="checkoutPhone" />
              </div>
            </div>
            <div className="checkout__payment">thanh toán</div>
