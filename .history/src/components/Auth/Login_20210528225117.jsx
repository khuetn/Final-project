...
function Login(props) {
  ...
  async function authenticateUser() {
    const { name, phone, address, email, password, passwordConfirm } = values;
    try {
      if (login) {
      ...
      <form onSubmit={handleSubmit} className="login__form">
        ...
        <div className="form__submit">
          <button
            ...
            style={{ background: isSubmitting ? "grey" : "grey" }}
          >
            <AiOutlineArrowRight style={{ fontSize: "35px", color: "white" }} />
