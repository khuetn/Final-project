...
const CartReducer = (state = initialState, action) => {
  ...
  switch (action.type) {
    ...
    case "REMOVE":
      ...
      let indexRemove = removeState.products.findIndex((pr) => pr.id === product.id);
      removeState.totalPrice =
        removeState.totalPrice - removeState.products[indexRemove].actualPrice*removeState.products[index].quantity;
      removeState.totalQuantities =
        removeState.totalQuantities - removeState.products[indexRemove].quantity;
