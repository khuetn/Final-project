...
const CartReducer = (state = initialState, action) => {
  ...
  switch (action.type) {
    ...
    case "INC":
      let incState = { ...state };
      let indexInc = incState.products.findIndex((pr) => pr.id === product.id);
      incState.totalPrice =
        incState.totalPrice +
        (quantity - incState.products[indexInc].quantity) * actualPrice;
      incState.totalQuantities =
        incState.totalQuantities +
        (quantity - incState.products[indexInc].quantity) * actualPrice;
      incState.products[indexInc] += quantity;
      return incState;
    case "DEC":
      let decState = { ...state };
    ...
    case "REMOVE":
      ...
      removeState.totalPrice =
        ...
        removeState.products[indexRemove].actualPrice *
          removeState.products[index].quantity;
