  ...
  switch (action.type) {
    case "ADD_TO_CART":
      ...
      if (check) {
        ...
        addState.totalPrice =
          addState.totalPrice +
          (quantity - addState.products[indexAdd].quantity) * actualPrice;
        addState.totalQuantities =
          addState.totalQuantities +
          (quantity - addState.products[indexAdd].quantity);
    ...
    case "INC":
      ...
      const actualPrice = incState.products[indexInc].discount
        ? (incState.products[indexInc].price *
            (100 - incState.products[indexInc].discount)) /
          100
        : incState.products[indexInc].price;
      incState.totalPrice = incState.totalPrice + actualPrice;
    ...
    case "DEC":
      ...
      const actualPrice = decState.products[indexInc].discount
        ? (decState.products[indexInc].price *
            (100 - decState.products[indexInc].discount)) /
          100
        : decState.products[indexInc].price;
      if (decState.products[indexDec].quantity > 1) {
        decState.totalPrice = decState.totalPrice - decState.products[indexDec];
