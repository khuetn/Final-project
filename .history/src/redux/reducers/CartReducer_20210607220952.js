  ...
  switch (action.type) {
    case "ADD_TO_CART":
      ...
      if (check) {
        ...
        console.log(product);
        console.log(quantity);
        const indexAdd = state.products.findIndex((pr) => pr.id === product.id);
        //--------------------------------------------------------
        ...
        const Tprice =
          state.totalPrice +
          actualPrice * (quantity - state.products[indexAdd].quantity);
        ...
        addState.products[indexAdd].quantity =
          state.products[indexAdd].quantity +
          (quantity - state.products[indexAdd].quantity);
        //------------------------------------------------------
        addState.products[indexAdd].selectedSize = size;
        //------------------------------------------------------
        return addState;
      } else {
