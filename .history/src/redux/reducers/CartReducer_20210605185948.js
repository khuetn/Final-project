  ...
  switch (action.type) {
    case "ADD_TO_CART":
      ...
      if (check) {
        ...
        let newListProducts = addState.product;
        newListProducts.push(addProduct);
        let addState.products = newListProducts
    ...
    case "DEC":
      ...
      const actualPriceDec = decState.products[indexInc].discount
